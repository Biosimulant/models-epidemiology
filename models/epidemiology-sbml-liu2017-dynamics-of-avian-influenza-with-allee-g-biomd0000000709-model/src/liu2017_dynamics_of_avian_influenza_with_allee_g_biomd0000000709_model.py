...
"""Auto-generated SBML BioModule wrapper for Liu2017 - Dynamics of Avian Influenza with Allee Growth Effect.

Source: biomodels_ebi:BIOMD0000000709
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000709
"""
...
class SbmlLiu2017DynamicsOfAvianInfluenzaWithAlleeGrowthEffect(biosim.BioModule):
    """BioModule wrapper for SBML model: Liu2017 - Dynamics of Avian Influenza with Allee Growth Effect."""

    def __init__(self, model_path: str = "data/BIOMD0000000709.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liu2017DynamicsOfAvianInfluenzaWithAlleeGBiomd0000000709Model = SbmlLiu2017DynamicsOfAvianInfluenzaWithAlleeGrowthEffect
