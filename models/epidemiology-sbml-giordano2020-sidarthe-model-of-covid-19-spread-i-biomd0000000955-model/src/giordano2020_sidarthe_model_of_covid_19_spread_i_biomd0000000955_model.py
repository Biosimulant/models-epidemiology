...
"""Auto-generated SBML BioModule wrapper for Giordano2020 - SIDARTHE model of COVID-19 spread in Italy.

Source: biomodels_ebi:BIOMD0000000955
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000955
"""
...
class SbmlGiordano2020SidartheModelOfCovid19SpreadInItaly(biosim.BioModule):
    """BioModule wrapper for SBML model: Giordano2020 - SIDARTHE model of COVID-19 spread in Italy."""

    def __init__(self, model_path: str = "data/BIOMD0000000955.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Giordano2020SidartheModelOfCovid19SpreadIBiomd0000000955Model = SbmlGiordano2020SidartheModelOfCovid19SpreadInItaly
