...
"""Auto-generated SBML BioModule wrapper for Okuonghae2020 - SEAIR model of COVID-19 transmission in Lagos, Nigeria.

Source: biomodels_ebi:BIOMD0000000991
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000991
"""
...
class SbmlOkuonghae2020SeairModelOfCovid19TransmissionInLagos(biosim.BioModule):
    """BioModule wrapper for SBML model: Okuonghae2020 - SEAIR model of COVID-19 transmission in Lagos, Nigeria."""

    def __init__(self, model_path: str = "data/BIOMD0000000991.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Okuonghae2020SeairModelOfCovid19TransmissiBiomd0000000991Model = SbmlOkuonghae2020SeairModelOfCovid19TransmissionInLagos
