...
"""Auto-generated SBML BioModule wrapper for Roda2020 - SIR model of COVID-19 spread in Wuhan.

Source: biomodels_ebi:BIOMD0000000957
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000957
"""
...
class SbmlRoda2020SirModelOfCovid19SpreadInWuhan(biosim.BioModule):
    """BioModule wrapper for SBML model: Roda2020 - SIR model of COVID-19 spread in Wuhan."""

    def __init__(self, model_path: str = "data/BIOMD0000000957.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Roda2020SirModelOfCovid19SpreadInWuhanBiomd0000000957Model = SbmlRoda2020SirModelOfCovid19SpreadInWuhan
