...
"""Auto-generated SBML BioModule wrapper for Fang2011 - Genome-scale metabolic network of Burkholderia cenocepacia (iKF1028).

Source: biomodels_ebi:MODEL1507180051
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180051
"""
...
class SbmlFang2011GenomeScaleMetabolicNetworkOfBurkholderia(biosim.BioModule):
    """BioModule wrapper for SBML model: Fang2011 - Genome-scale metabolic network of Burkholderia cenocepacia (iKF1028)."""

    def __init__(self, model_path: str = "data/MODEL1507180051.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fang2011GenomeScaleMetabolicNetworkOfBurkhModel1507180051Model = SbmlFang2011GenomeScaleMetabolicNetworkOfBurkholderia
