...
"""Auto-generated SBML BioModule wrapper for Delattre2020 - SARS-CoV-2-infected human lung cell.

Source: biomodels_ebi:MODEL2010280002
Original: https://www.ebi.ac.uk/biomodels/MODEL2010280002
"""
...
class SbmlDelattre2020SarsCov2InfectedHumanLungCell(biosim.BioModule):
    """BioModule wrapper for SBML model: Delattre2020 - SARS-CoV-2-infected human lung cell."""

    def __init__(self, model_path: str = "data/MODEL2010280002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Delattre2020SarsCov2InfectedHumanLungCellModel2010280002Model = SbmlDelattre2020SarsCov2InfectedHumanLungCell
