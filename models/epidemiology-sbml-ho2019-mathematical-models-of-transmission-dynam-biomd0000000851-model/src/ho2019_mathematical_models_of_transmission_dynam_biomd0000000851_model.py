...
"""Auto-generated SBML BioModule wrapper for Ho2019 - Mathematical models of transmission dynamics and vaccine strategies in Hong Kong during the 2017-2018 winter influenza season (Simple).

Source: biomodels_ebi:BIOMD0000000851
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000851
"""
...
class SbmlHo2019MathematicalModelsOfTransmissionDynamicsAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Ho2019 - Mathematical models of transmission dynamics and vaccine strategies in Hong Kong during the 2017-2018 winter influenza season (Simple)."""

    def __init__(self, model_path: str = "data/BIOMD0000000851.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ho2019MathematicalModelsOfTransmissionDynamBiomd0000000851Model = SbmlHo2019MathematicalModelsOfTransmissionDynamicsAnd
