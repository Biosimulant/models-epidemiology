...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/BIOMD0000000851)
**Standard**: sbml
**Authors**: Shing Hei Ho; Daihai He; Eftimie R
...
models:
  - path: ../../models/epidemiology-sbml-ho2019-mathematical-models-of-transmission-dynam-biomd0000000851-model
    alias: model
```
