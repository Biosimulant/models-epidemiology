...
"""Auto-generated SBML BioModule wrapper for Law2020 - SIR model of COVID-19 transmission in Malyasia with time-varying parameters.

Source: biomodels_ebi:BIOMD0000000982
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000982
"""
...
class SbmlLaw2020SirModelOfCovid19TransmissionInMalyasiaWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Law2020 - SIR model of COVID-19 transmission in Malyasia with time-varying parameters."""

    def __init__(self, model_path: str = "data/BIOMD0000000982.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Law2020SirModelOfCovid19TransmissionInMaBiomd0000000982Model = SbmlLaw2020SirModelOfCovid19TransmissionInMalyasiaWith
