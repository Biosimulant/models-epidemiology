...
"""Auto-generated SBML BioModule wrapper for Model-based prediction of SARS-CoV-2 in Ethiopia: Extended SEIR model.

Source: biomodels_ebi:MODEL2212310001
Original: https://www.ebi.ac.uk/biomodels/MODEL2212310001
"""
...
class SbmlModelBasedPredictionOfSarsCov2InEthiopiaExtended(biosim.BioModule):
    """BioModule wrapper for SBML model: Model-based prediction of SARS-CoV-2 in Ethiopia: Extended SEIR model."""

    def __init__(self, model_path: str = "data/MODEL2212310001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ModelBasedPredictionOfSarsCov2InEthiopiaModel2212310001Model = SbmlModelBasedPredictionOfSarsCov2InEthiopiaExtended
