...
"""Auto-generated SBML BioModule wrapper for Malkov2020 - SEIRS model of COVID-19 transmission with time-varying R values and reinfection.

Source: biomodels_ebi:BIOMD0000000980
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000980
"""
...
class SbmlMalkov2020SeirsModelOfCovid19TransmissionWithTime(biosim.BioModule):
    """BioModule wrapper for SBML model: Malkov2020 - SEIRS model of COVID-19 transmission with time-varying R values and reinfection."""

    def __init__(self, model_path: str = "data/BIOMD0000000980.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Malkov2020SeirsModelOfCovid19TransmissionBiomd0000000980Model = SbmlMalkov2020SeirsModelOfCovid19TransmissionWithTime
