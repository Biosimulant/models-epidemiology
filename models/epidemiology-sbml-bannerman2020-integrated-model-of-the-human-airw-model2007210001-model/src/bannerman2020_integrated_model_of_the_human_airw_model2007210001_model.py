...
"""Auto-generated SBML BioModule wrapper for Bannerman2020 - Integrated model of the human airway epithelial cell and the SARS-CoV-2 virus.

Source: biomodels_ebi:MODEL2007210001
Original: https://www.ebi.ac.uk/biomodels/MODEL2007210001
"""
...
class SbmlBannerman2020IntegratedModelOfTheHumanAirway(biosim.BioModule):
    """BioModule wrapper for SBML model: Bannerman2020 - Integrated model of the human airway epithelial cell and the SARS-CoV-2 virus."""

    def __init__(self, model_path: str = "data/MODEL2007210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bannerman2020IntegratedModelOfTheHumanAirwModel2007210001Model = SbmlBannerman2020IntegratedModelOfTheHumanAirway
