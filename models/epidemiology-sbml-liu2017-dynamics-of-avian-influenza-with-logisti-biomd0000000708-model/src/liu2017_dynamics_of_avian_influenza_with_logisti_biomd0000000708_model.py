...
"""Auto-generated SBML BioModule wrapper for Liu2017 - Dynamics of Avian Influenza with Logistic Growth.

Source: biomodels_ebi:BIOMD0000000708
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000708
"""
...
class SbmlLiu2017DynamicsOfAvianInfluenzaWithLogisticGrowth(biosim.BioModule):
    """BioModule wrapper for SBML model: Liu2017 - Dynamics of Avian Influenza with Logistic Growth."""

    def __init__(self, model_path: str = "data/BIOMD0000000708.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liu2017DynamicsOfAvianInfluenzaWithLogistiBiomd0000000708Model = SbmlLiu2017DynamicsOfAvianInfluenzaWithLogisticGrowth
