...
"""Auto-generated SBML BioModule wrapper for Hou2020 - SEIR model of COVID-19 transmission in Wuhan.

Source: biomodels_ebi:BIOMD0000000970
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000970
"""
...
class SbmlHou2020SeirModelOfCovid19TransmissionInWuhan(biosim.BioModule):
    """BioModule wrapper for SBML model: Hou2020 - SEIR model of COVID-19 transmission in Wuhan."""

    def __init__(self, model_path: str = "data/BIOMD0000000970.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hou2020SeirModelOfCovid19TransmissionInWBiomd0000000970Model = SbmlHou2020SeirModelOfCovid19TransmissionInWuhan
