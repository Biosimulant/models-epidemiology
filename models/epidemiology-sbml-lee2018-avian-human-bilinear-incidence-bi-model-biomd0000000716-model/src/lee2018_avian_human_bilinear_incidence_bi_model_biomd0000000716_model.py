...
"""Auto-generated SBML BioModule wrapper for Lee2018 - Avian human bilinear incidence (BI) model.

Source: biomodels_ebi:BIOMD0000000716
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000716
"""
...
class SbmlLee2018AvianHumanBilinearIncidenceBiModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2018 - Avian human bilinear incidence (BI) model."""

    def __init__(self, model_path: str = "data/BIOMD0000000716.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2018AvianHumanBilinearIncidenceBiModelBiomd0000000716Model = SbmlLee2018AvianHumanBilinearIncidenceBiModel
