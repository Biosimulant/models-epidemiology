...
"""Auto-generated SBML BioModule wrapper for Mukhta2018-the effect of bednet coverage on malaria transmission in South Sudan.

Source: biomodels_ebi:MODEL2003160003
Original: https://www.ebi.ac.uk/biomodels/MODEL2003160003
"""
...
class SbmlMukhta2018TheEffectOfBednetCoverageOnMalaria(biosim.BioModule):
    """BioModule wrapper for SBML model: Mukhta2018-the effect of bednet coverage on malaria transmission in South Sudan."""

    def __init__(self, model_path: str = "data/MODEL2003160003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mukhta2018TheEffectOfBednetCoverageOnMalaModel2003160003Model = SbmlMukhta2018TheEffectOfBednetCoverageOnMalaria
