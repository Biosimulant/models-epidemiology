...
"""Auto-generated SBML BioModule wrapper for COVID-19 immunotherapy A mathematical model.

Source: biomodels_ebi:MODEL2202230002
Original: https://www.ebi.ac.uk/biomodels/MODEL2202230002
"""
...
class SbmlCovid19ImmunotherapyAMathematicalModel2(biosim.BioModule):
    """BioModule wrapper for SBML model: COVID-19 immunotherapy A mathematical model."""

    def __init__(self, model_path: str = "data/MODEL2202230002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Covid19ImmunotherapyAMathematicalModelModel2202230002Model = SbmlCovid19ImmunotherapyAMathematicalModel2
