...
"""Auto-generated SBML BioModule wrapper for Ghanbari2020 - forecasting the second wave of COVID-19 in Iran.

Source: biomodels_ebi:BIOMD0000000976
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000976
"""
...
class SbmlGhanbari2020ForecastingTheSecondWaveOfCovid19InIran(biosim.BioModule):
    """BioModule wrapper for SBML model: Ghanbari2020 - forecasting the second wave of COVID-19 in Iran."""

    def __init__(self, model_path: str = "data/BIOMD0000000976.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ghanbari2020ForecastingTheSecondWaveOfCoviBiomd0000000976Model = SbmlGhanbari2020ForecastingTheSecondWaveOfCovid19InIran
