...
"""Auto-generated SBML BioModule wrapper for Carcione2020 - Deterministic SEIR simulation of a COVID-19 outbreak.

Source: biomodels_ebi:BIOMD0000000974
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000974
"""
...
class SbmlCarcione2020DeterministicSeirSimulationOfACovid19(biosim.BioModule):
    """BioModule wrapper for SBML model: Carcione2020 - Deterministic SEIR simulation of a COVID-19 outbreak."""

    def __init__(self, model_path: str = "data/BIOMD0000000974.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Carcione2020DeterministicSeirSimulationOfABiomd0000000974Model = SbmlCarcione2020DeterministicSeirSimulationOfACovid19
