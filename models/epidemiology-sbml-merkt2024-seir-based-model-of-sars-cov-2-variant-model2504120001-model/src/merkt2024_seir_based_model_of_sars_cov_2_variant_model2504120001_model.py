...
"""Auto-generated SBML BioModule wrapper for Merkt2024 - SEIR based model of SARS-CoV-2 variant spread and cross-immunity in Ethiopia.

Source: biomodels_ebi:MODEL2504120001
Original: https://www.ebi.ac.uk/biomodels/MODEL2504120001
"""
...
class SbmlMerkt2024SeirBasedModelOfSarsCov2VariantSpreadAnd(bsim.BioModule):
    """BioModule wrapper for SBML model: Merkt2024 - SEIR based model of SARS-CoV-2 variant spread and cross-immunity in Ethiopia."""

    def __init__(self, model_path: str = "data/MODEL2504120001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Merkt2024SeirBasedModelOfSarsCov2VariantModel2504120001Model = SbmlMerkt2024SeirBasedModelOfSarsCov2VariantSpreadAnd
