...
"""Auto-generated SBML BioModule wrapper for Wan2020 - risk estimation and prediction of the transmission of COVID-19 in maninland China excluding Hubei province.

Source: biomodels_ebi:BIOMD0000000981
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000981
"""
...
class SbmlWan2020RiskEstimationAndPredictionOfTheTransmission(biosim.BioModule):
    """BioModule wrapper for SBML model: Wan2020 - risk estimation and prediction of the transmission of COVID-19 in maninland China excluding Hubei province."""

    def __init__(self, model_path: str = "data/BIOMD0000000981.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wan2020RiskEstimationAndPredictionOfTheTrBiomd0000000981Model = SbmlWan2020RiskEstimationAndPredictionOfTheTransmission
