...
"""Auto-generated SBML BioModule wrapper for Ducrot2009 - Malaria transmission in two host types.

Source: biomodels_ebi:MODEL1808280013
Original: https://www.ebi.ac.uk/biomodels/MODEL1808280013
"""
...
class SbmlDucrot2009MalariaTransmissionInTwoHostTypes(biosim.BioModule):
    """BioModule wrapper for SBML model: Ducrot2009 - Malaria transmission in two host types."""

    def __init__(self, model_path: str = "data/MODEL1808280013.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ducrot2009MalariaTransmissionInTwoHostTypeModel1808280013Model = SbmlDucrot2009MalariaTransmissionInTwoHostTypes
