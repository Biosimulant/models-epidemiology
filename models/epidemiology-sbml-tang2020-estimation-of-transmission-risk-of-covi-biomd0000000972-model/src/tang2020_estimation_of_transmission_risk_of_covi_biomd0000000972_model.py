...
"""Auto-generated SBML BioModule wrapper for Tang2020 - Estimation of transmission risk of COVID-19 and impact of public health interventions - update.

Source: biomodels_ebi:BIOMD0000000972
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000972
"""
...
class SbmlTang2020EstimationOfTransmissionRiskOfCovid19And2(biosim.BioModule):
    """BioModule wrapper for SBML model: Tang2020 - Estimation of transmission risk of COVID-19 and impact of public health interventions - update."""

    def __init__(self, model_path: str = "data/BIOMD0000000972.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tang2020EstimationOfTransmissionRiskOfCoviBiomd0000000972Model = SbmlTang2020EstimationOfTransmissionRiskOfCovid19And2
