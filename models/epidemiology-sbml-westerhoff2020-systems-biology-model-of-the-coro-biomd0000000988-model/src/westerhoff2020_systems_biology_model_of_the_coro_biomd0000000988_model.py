...
"""Auto-generated SBML BioModule wrapper for Westerhoff2020 - systems biology model of the coronavirus pandemic 2020.

Source: biomodels_ebi:BIOMD0000000988
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000988
"""
...
class SbmlWesterhoff2020SystemsBiologyModelOfTheCoronavirus(biosim.BioModule):
    """BioModule wrapper for SBML model: Westerhoff2020 - systems biology model of the coronavirus pandemic 2020."""

    def __init__(self, model_path: str = "data/BIOMD0000000988.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Westerhoff2020SystemsBiologyModelOfTheCoroBiomd0000000988Model = SbmlWesterhoff2020SystemsBiologyModelOfTheCoronavirus
