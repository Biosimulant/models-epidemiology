...
"""Auto-generated SBML BioModule wrapper for Smith&Moore2004 - The SIR model for the spread of HongKong Flu.

Source: biomodels_ebi:BIOMD0000001045
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001045
"""
...
class SbmlSmithMoore2004TheSirModelForTheSpreadOfHongkongFlu(biosim.BioModule):
    """BioModule wrapper for SBML model: Smith&Moore2004 - The SIR model for the spread of HongKong Flu."""

    def __init__(self, model_path: str = "data/BIOMD0000001045.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smithandmoore2004TheSirModelForTheSpreadOBiomd0000001045Model = SbmlSmithMoore2004TheSirModelForTheSpreadOfHongkongFlu
