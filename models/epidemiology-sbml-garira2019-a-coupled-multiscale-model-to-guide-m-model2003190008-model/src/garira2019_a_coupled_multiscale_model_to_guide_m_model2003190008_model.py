...
"""Auto-generated SBML BioModule wrapper for Garira2019 - A coupled multiscale model to guide malaria control and elimination.

Source: biomodels_ebi:MODEL2003190008
Original: https://www.ebi.ac.uk/biomodels/MODEL2003190008
"""
...
class SbmlGarira2019ACoupledMultiscaleModelToGuideMalaria(biosim.BioModule):
    """BioModule wrapper for SBML model: Garira2019 - A coupled multiscale model to guide malaria control and elimination."""

    def __init__(self, model_path: str = "data/MODEL2003190008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Garira2019ACoupledMultiscaleModelToGuideMModel2003190008Model = SbmlGarira2019ACoupledMultiscaleModelToGuideMalaria
