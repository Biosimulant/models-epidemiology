...
"""Auto-generated SBML BioModule wrapper for Burbano2023 - HGFsignaling_in_FattyLiverDisease.

Source: biomodels_ebi:BIOMD0000001102
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001102
"""
...
class SbmlBurbano2023HgfsignalingInFattyliverdisease(biosim.BioModule):
    """BioModule wrapper for SBML model: Burbano2023 - HGFsignaling_in_FattyLiverDisease."""

    def __init__(self, model_path: str = "data/BIOMD0000001102.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Burbano2023HgfsignalingInFattyliverdiseaseBiomd0000001102Model = SbmlBurbano2023HgfsignalingInFattyliverdisease
