...
"""Auto-generated SBML BioModule wrapper for Renz2020 - GEM of Human alveolar macrophage with SARS-CoV-2.

Source: biomodels_ebi:MODEL2003020001
Original: https://www.ebi.ac.uk/biomodels/MODEL2003020001
"""
...
class SbmlRenz2020GemOfHumanAlveolarMacrophageWithSarsCov2(biosim.BioModule):
    """BioModule wrapper for SBML model: Renz2020 - GEM of Human alveolar macrophage with SARS-CoV-2."""

    def __init__(self, model_path: str = "data/MODEL2003020001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Renz2020GemOfHumanAlveolarMacrophageWithSModel2003020001Model = SbmlRenz2020GemOfHumanAlveolarMacrophageWithSarsCov2
