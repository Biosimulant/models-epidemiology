...
"""Auto-generated SBML BioModule wrapper for Tang2020 - Estimation of transmission risk of COVID-19 and impact of public health interventions.

Source: biomodels_ebi:BIOMD0000000971
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000971
"""
...
class SbmlTang2020EstimationOfTransmissionRiskOfCovid19And(biosim.BioModule):
    """BioModule wrapper for SBML model: Tang2020 - Estimation of transmission risk of COVID-19 and impact of public health interventions."""

    def __init__(self, model_path: str = "data/BIOMD0000000971.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tang2020EstimationOfTransmissionRiskOfCoviBiomd0000000971Model = SbmlTang2020EstimationOfTransmissionRiskOfCovid19And
