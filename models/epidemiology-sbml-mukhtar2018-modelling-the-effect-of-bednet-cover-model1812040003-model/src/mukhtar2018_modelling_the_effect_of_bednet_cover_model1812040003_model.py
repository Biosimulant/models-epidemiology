...
"""Auto-generated SBML BioModule wrapper for Mukhtar2018 - Modelling the effect of bednet coverage on malaria transmission in South Sudan..

Source: biomodels_ebi:MODEL1812040003
Original: https://www.ebi.ac.uk/biomodels/MODEL1812040003
"""
...
class SbmlMukhtar2018ModellingTheEffectOfBednetCoverageOn(biosim.BioModule):
    """BioModule wrapper for SBML model: Mukhtar2018 - Modelling the effect of bednet coverage on malaria transmission in South Sudan.."""

    def __init__(self, model_path: str = "data/MODEL1812040003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mukhtar2018ModellingTheEffectOfBednetCoverModel1812040003Model = SbmlMukhtar2018ModellingTheEffectOfBednetCoverageOn
