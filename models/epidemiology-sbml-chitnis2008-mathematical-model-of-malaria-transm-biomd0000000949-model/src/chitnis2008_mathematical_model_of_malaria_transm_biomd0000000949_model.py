...
"""Auto-generated SBML BioModule wrapper for Chitnis2008 - Mathematical model of malaria transmission.

Source: biomodels_ebi:BIOMD0000000949
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000949
"""
...
class SbmlChitnis2008MathematicalModelOfMalariaTransmission(biosim.BioModule):
    """BioModule wrapper for SBML model: Chitnis2008 - Mathematical model of malaria transmission."""

    def __init__(self, model_path: str = "data/BIOMD0000000949.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chitnis2008MathematicalModelOfMalariaTransmBiomd0000000949Model = SbmlChitnis2008MathematicalModelOfMalariaTransmission
