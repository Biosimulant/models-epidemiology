...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/BIOMD0000000962)
**Standard**: sbml
...
models:
  - path: ../../models/epidemiology-sbml-zhao2020-suqc-model-of-covid-19-transmission-dyn-biomd0000000962-model
    alias: model
```
