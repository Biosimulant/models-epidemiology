...
"""Auto-generated SBML BioModule wrapper for Zhao2020 - SUQC model of COVID-19 transmission dynamics in Wuhan, Hubei, and China.

Source: biomodels_ebi:BIOMD0000000962
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000962
"""
...
class SbmlZhao2020SuqcModelOfCovid19TransmissionDynamicsIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhao2020 - SUQC model of COVID-19 transmission dynamics in Wuhan, Hubei, and China."""

    def __init__(self, model_path: str = "data/BIOMD0000000962.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhao2020SuqcModelOfCovid19TransmissionDynBiomd0000000962Model = SbmlZhao2020SuqcModelOfCovid19TransmissionDynamicsIn
