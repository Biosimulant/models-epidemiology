...
Source: biomodels_ebi:MODEL2109130003
Original: https://www.ebi.ac.uk/biomodels/MODEL2109130003
"""
...
class SbmlCovid19ImmunotherapyAMathematicalModel(biosim.BioModule):
    """BioModule wrapper for SBML model: COVID-19 immunotherapy A mathematical model."""

    def __init__(self, model_path: str = "data/MODEL2109130003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Covid19ImmunotherapyAMathematicalModelModel2109130003Model = SbmlCovid19ImmunotherapyAMathematicalModel
