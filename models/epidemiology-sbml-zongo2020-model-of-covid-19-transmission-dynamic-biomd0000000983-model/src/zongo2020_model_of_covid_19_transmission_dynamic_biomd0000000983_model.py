...
"""Auto-generated SBML BioModule wrapper for Zongo2020 - model of COVID-19 transmission dynamics under containment measures in France.

Source: biomodels_ebi:BIOMD0000000983
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000983
"""
...
class SbmlZongo2020ModelOfCovid19TransmissionDynamicsUnder(biosim.BioModule):
    """BioModule wrapper for SBML model: Zongo2020 - model of COVID-19 transmission dynamics under containment measures in France."""

    def __init__(self, model_path: str = "data/BIOMD0000000983.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zongo2020ModelOfCovid19TransmissionDynamicBiomd0000000983Model = SbmlZongo2020ModelOfCovid19TransmissionDynamicsUnder
