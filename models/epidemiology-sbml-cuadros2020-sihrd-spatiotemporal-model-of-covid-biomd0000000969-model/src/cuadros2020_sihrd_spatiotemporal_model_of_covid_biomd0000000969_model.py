...
"""Auto-generated SBML BioModule wrapper for Cuadros2020 - SIHRD spatiotemporal model of COVID-19 transmission in Ohio.

Source: biomodels_ebi:BIOMD0000000969
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000969
"""
...
class SbmlCuadros2020SihrdSpatiotemporalModelOfCovid19(biosim.BioModule):
    """BioModule wrapper for SBML model: Cuadros2020 - SIHRD spatiotemporal model of COVID-19 transmission in Ohio."""

    def __init__(self, model_path: str = "data/BIOMD0000000969.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cuadros2020SihrdSpatiotemporalModelOfCovidBiomd0000000969Model = SbmlCuadros2020SihrdSpatiotemporalModelOfCovid19
