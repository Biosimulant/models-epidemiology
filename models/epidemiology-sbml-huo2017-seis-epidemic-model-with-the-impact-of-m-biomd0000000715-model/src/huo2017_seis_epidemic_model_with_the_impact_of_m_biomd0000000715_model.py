...
"""Auto-generated SBML BioModule wrapper for Huo2017 - SEIS epidemic model with the impact of media.

Source: biomodels_ebi:BIOMD0000000715
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000715
"""
...
class SbmlHuo2017SeisEpidemicModelWithTheImpactOfMedia(biosim.BioModule):
    """BioModule wrapper for SBML model: Huo2017 - SEIS epidemic model with the impact of media."""

    def __init__(self, model_path: str = "data/BIOMD0000000715.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Huo2017SeisEpidemicModelWithTheImpactOfMBiomd0000000715Model = SbmlHuo2017SeisEpidemicModelWithTheImpactOfMedia
