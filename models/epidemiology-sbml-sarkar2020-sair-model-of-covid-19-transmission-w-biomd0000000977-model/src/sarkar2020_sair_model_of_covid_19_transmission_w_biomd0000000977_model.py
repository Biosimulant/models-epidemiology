...
"""Auto-generated SBML BioModule wrapper for Sarkar2020 - SAIR model of COVID-19 transmission with quarantine measures in India.

Source: biomodels_ebi:BIOMD0000000977
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000977
"""
...
class SbmlSarkar2020SairModelOfCovid19TransmissionWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Sarkar2020 - SAIR model of COVID-19 transmission with quarantine measures in India."""

    def __init__(self, model_path: str = "data/BIOMD0000000977.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sarkar2020SairModelOfCovid19TransmissionWBiomd0000000977Model = SbmlSarkar2020SairModelOfCovid19TransmissionWith
