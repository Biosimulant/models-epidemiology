...
"""Auto-generated SBML BioModule wrapper for Lee2018 - Avian human half-saturated incidence (HSI) model.

Source: biomodels_ebi:BIOMD0000000717
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000717
"""
...
class SbmlLee2018AvianHumanHalfSaturatedIncidenceHsiModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2018 - Avian human half-saturated incidence (HSI) model."""

    def __init__(self, model_path: str = "data/BIOMD0000000717.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2018AvianHumanHalfSaturatedIncidenceHsiBiomd0000000717Model = SbmlLee2018AvianHumanHalfSaturatedIncidenceHsiModel
