...
"""Auto-generated SBML BioModule wrapper for Leander2021 - innate immune response to SARS-CoV-2 in the alveolar epithelium.

Source: biomodels_ebi:MODEL2111170001
Original: https://www.ebi.ac.uk/biomodels/MODEL2111170001
"""
...
class SbmlLeander2021InnateImmuneResponseToSarsCov2InThe(biosim.BioModule):
    """BioModule wrapper for SBML model: Leander2021 - innate immune response to SARS-CoV-2 in the alveolar epithelium."""

    def __init__(self, model_path: str = "data/MODEL2111170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leander2021InnateImmuneResponseToSarsCov2Model2111170001Model = SbmlLeander2021InnateImmuneResponseToSarsCov2InThe
