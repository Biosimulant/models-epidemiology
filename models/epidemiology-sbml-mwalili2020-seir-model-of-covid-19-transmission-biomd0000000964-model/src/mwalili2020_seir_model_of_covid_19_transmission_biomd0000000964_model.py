...
"""Auto-generated SBML BioModule wrapper for Mwalili2020 - SEIR model of COVID-19 transmission and environmental pathogen prevalence.

Source: biomodels_ebi:BIOMD0000000964
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000964
"""
...
class SbmlMwalili2020SeirModelOfCovid19TransmissionAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Mwalili2020 - SEIR model of COVID-19 transmission and environmental pathogen prevalence."""

    def __init__(self, model_path: str = "data/BIOMD0000000964.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mwalili2020SeirModelOfCovid19TransmissionBiomd0000000964Model = SbmlMwalili2020SeirModelOfCovid19TransmissionAnd
