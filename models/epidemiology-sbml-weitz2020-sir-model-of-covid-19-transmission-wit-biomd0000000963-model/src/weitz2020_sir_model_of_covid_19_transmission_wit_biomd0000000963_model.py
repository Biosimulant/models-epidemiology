...
"""Auto-generated SBML BioModule wrapper for Weitz2020 - SIR model of COVID-19 transmission with shielding.

Source: biomodels_ebi:BIOMD0000000963
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000963
"""
...
class SbmlWeitz2020SirModelOfCovid19TransmissionWithShielding(biosim.BioModule):
    """BioModule wrapper for SBML model: Weitz2020 - SIR model of COVID-19 transmission with shielding."""

    def __init__(self, model_path: str = "data/BIOMD0000000963.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Weitz2020SirModelOfCovid19TransmissionWitBiomd0000000963Model = SbmlWeitz2020SirModelOfCovid19TransmissionWithShielding
