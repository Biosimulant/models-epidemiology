...
"""Auto-generated SBML BioModule wrapper for Chitnis2012 - Model Rift Valley Fever transmission between cattle and mosquitoes (Model 1).

Source: biomodels_ebi:BIOMD0000000950
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000950
"""
...
class SbmlChitnis2012ModelRiftValleyFeverTransmissionBetween(biosim.BioModule):
    """BioModule wrapper for SBML model: Chitnis2012 - Model Rift Valley Fever transmission between cattle and mosquitoes (Model 1)."""

    def __init__(self, model_path: str = "data/BIOMD0000000950.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chitnis2012ModelRiftValleyFeverTransmissionBiomd0000000950Model = SbmlChitnis2012ModelRiftValleyFeverTransmissionBetween
