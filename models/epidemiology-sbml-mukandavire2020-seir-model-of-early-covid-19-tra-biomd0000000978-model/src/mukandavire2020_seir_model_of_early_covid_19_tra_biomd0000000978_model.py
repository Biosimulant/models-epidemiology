...
"""Auto-generated SBML BioModule wrapper for Mukandavire2020 - SEIR model of early COVID-19 transmission in South Africa.

Source: biomodels_ebi:BIOMD0000000978
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000978
"""
...
class SbmlMukandavire2020SeirModelOfEarlyCovid19Transmission(biosim.BioModule):
    """BioModule wrapper for SBML model: Mukandavire2020 - SEIR model of early COVID-19 transmission in South Africa."""

    def __init__(self, model_path: str = "data/BIOMD0000000978.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mukandavire2020SeirModelOfEarlyCovid19TraBiomd0000000978Model = SbmlMukandavire2020SeirModelOfEarlyCovid19Transmission
