...
"""Auto-generated SBML BioModule wrapper for Ruan2017 - Transmission dynamics and control of rabies in China.

Source: biomodels_ebi:BIOMD0000000726
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000726
"""
...
class SbmlRuan2017TransmissionDynamicsAndControlOfRabiesIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Ruan2017 - Transmission dynamics and control of rabies in China."""

    def __init__(self, model_path: str = "data/BIOMD0000000726.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ruan2017TransmissionDynamicsAndControlOfRaBiomd0000000726Model = SbmlRuan2017TransmissionDynamicsAndControlOfRabiesIn
