...
"""Auto-generated SBML BioModule wrapper for Ndairou2020 - early-stage transmission dynamics of COVID-19 in Wuhan.

Source: biomodels_ebi:BIOMD0000000958
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000958
"""
...
class SbmlNdairou2020EarlyStageTransmissionDynamicsOfCovid19(biosim.BioModule):
    """BioModule wrapper for SBML model: Ndairou2020 - early-stage transmission dynamics of COVID-19 in Wuhan."""

    def __init__(self, model_path: str = "data/BIOMD0000000958.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ndairou2020EarlyStageTransmissionDynamicsOfBiomd0000000958Model = SbmlNdairou2020EarlyStageTransmissionDynamicsOfCovid19
