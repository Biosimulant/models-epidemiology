...
"""Auto-generated SBML BioModule wrapper for Miroshnichenko2025 - A modular model of immune response to SARS-CoV-2 infection.

Source: biomodels_ebi:MODEL2503040001
Original: https://www.ebi.ac.uk/biomodels/MODEL2503040001
"""
...
class SbmlMiroshnichenko2025AModularModelOfImmuneResponseTo(biosim.BioModule):
    """BioModule wrapper for SBML model: Miroshnichenko2025 - A modular model of immune response to SARS-CoV-2 infection."""

    def __init__(self, model_path: str = "data/MODEL2503040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Miroshnichenko2025AModularModelOfImmuneResModel2503040001Model = SbmlMiroshnichenko2025AModularModelOfImmuneResponseTo
