...
"""Auto-generated SBML BioModule wrapper for Ndii2015-transmission dynamics of dengue in the presence of Wolbachia..

Source: biomodels_ebi:MODEL2003160002
Original: https://www.ebi.ac.uk/biomodels/MODEL2003160002
"""
...
class SbmlNdii2015TransmissionDynamicsOfDengueInThePresenceOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Ndii2015-transmission dynamics of dengue in the presence of Wolbachia.."""

    def __init__(self, model_path: str = "data/MODEL2003160002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ndii2015TransmissionDynamicsOfDengueInTheModel2003160002Model = SbmlNdii2015TransmissionDynamicsOfDengueInThePresenceOf
