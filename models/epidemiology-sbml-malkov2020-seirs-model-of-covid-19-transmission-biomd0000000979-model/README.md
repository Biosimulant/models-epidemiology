...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/BIOMD0000000979)
**Standard**: sbml
**Authors**: Egor Malkov
...
models:
  - path: ../../models/epidemiology-sbml-malkov2020-seirs-model-of-covid-19-transmission-biomd0000000979-model
    alias: model
```
