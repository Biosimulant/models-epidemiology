...
"""Auto-generated SBML BioModule wrapper for Turner2015 - Human/Mosquito SEIR/SEI Model.

Source: biomodels_ebi:MODEL1805220001
Original: https://www.ebi.ac.uk/biomodels/MODEL1805220001
"""
...
class SbmlTurner2015HumanMosquitoSeirSeiModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Turner2015 - Human/Mosquito SEIR/SEI Model."""

    def __init__(self, model_path: str = "data/MODEL1805220001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Turner2015HumanMosquitoSeirSeiModelModel1805220001Model = SbmlTurner2015HumanMosquitoSeirSeiModel
