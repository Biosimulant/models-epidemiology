...
"""Auto-generated SBML BioModule wrapper for Bertozzi2020 - SIR model of scenarios of COVID-19 spread in CA and NY.

Source: biomodels_ebi:BIOMD0000000956
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000956
"""
...
class SbmlBertozzi2020SirModelOfScenariosOfCovid19SpreadIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Bertozzi2020 - SIR model of scenarios of COVID-19 spread in CA and NY."""

    def __init__(self, model_path: str = "data/BIOMD0000000956.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bertozzi2020SirModelOfScenariosOfCovid19Biomd0000000956Model = SbmlBertozzi2020SirModelOfScenariosOfCovid19SpreadIn
