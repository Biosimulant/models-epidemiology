...
"""Auto-generated SBML BioModule wrapper for Paiva2020 - SEIAHRD model of transmission dynamics of COVID-19.

Source: biomodels_ebi:BIOMD0000000960
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000960
"""
...
class SbmlPaiva2020SeiahrdModelOfTransmissionDynamicsOfCovid19(biosim.BioModule):
    """BioModule wrapper for SBML model: Paiva2020 - SEIAHRD model of transmission dynamics of COVID-19."""

    def __init__(self, model_path: str = "data/BIOMD0000000960.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Paiva2020SeiahrdModelOfTransmissionDynamicsBiomd0000000960Model = SbmlPaiva2020SeiahrdModelOfTransmissionDynamicsOfCovid19
