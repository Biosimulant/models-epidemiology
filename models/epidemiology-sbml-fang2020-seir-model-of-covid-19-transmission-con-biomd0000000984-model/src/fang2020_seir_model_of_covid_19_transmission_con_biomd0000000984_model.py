...
"""Auto-generated SBML BioModule wrapper for Fang2020 - SEIR model of COVID-19 transmission considering government interventions in Wuhan.

Source: biomodels_ebi:BIOMD0000000984
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000984
"""
...
class SbmlFang2020SeirModelOfCovid19TransmissionConsidering(biosim.BioModule):
    """BioModule wrapper for SBML model: Fang2020 - SEIR model of COVID-19 transmission considering government interventions in Wuhan."""

    def __init__(self, model_path: str = "data/BIOMD0000000984.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fang2020SeirModelOfCovid19TransmissionConBiomd0000000984Model = SbmlFang2020SeirModelOfCovid19TransmissionConsidering
