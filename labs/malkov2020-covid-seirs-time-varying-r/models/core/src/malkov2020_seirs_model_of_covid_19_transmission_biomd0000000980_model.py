...
"""Curated Tellurium SBML wrapper for Malkov2020 - SEIRS model of COVID-19 transmission with time-varying R values and reinfection."""
...
class CuratedEpidemiologySBMLModel(TelluriumSBMLBioModule):
    _SBML_ID = 'BIOMD0000000980'
    _TITLE = 'Malkov2020 - SEIRS model of COVID-19 transmission with time-varying R values and reinfection'
    _TIME_UNIT = 'day'
...
Malkov2020SeirsModelOfCovid19TransmissionBiomd0000000980Model = CuratedEpidemiologySBMLModel
