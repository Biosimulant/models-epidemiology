...
"""Curated Tellurium SBML wrapper for Lee2018 - Avian human half-saturated incidence (HSI) model."""
...
class CuratedEpidemiologySBMLModel(TelluriumSBMLBioModule):
    _SBML_ID = 'BIOMD0000000717'
    _TITLE = 'Lee2018 - Avian human half-saturated incidence (HSI) model'
    _TIME_UNIT = 'day'
...
Lee2018AvianHumanHalfSaturatedIncidenceHsiBiomd0000000717Model = CuratedEpidemiologySBMLModel
