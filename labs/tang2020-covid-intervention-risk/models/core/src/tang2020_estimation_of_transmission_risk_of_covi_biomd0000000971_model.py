...
"""Curated Tellurium SBML wrapper for Tang2020 - Estimation of transmission risk of COVID-19 and impact of public health interventions."""
...
class CuratedEpidemiologySBMLModel(TelluriumSBMLBioModule):
    _SBML_ID = 'BIOMD0000000971'
    _TITLE = 'Tang2020 - Estimation of transmission risk of COVID-19 and impact of public health interventions'
    _TIME_UNIT = 'day'
    ...
    _PARAMETER_INPUTS = {'transmission_probability': ('beta', 2.1011e-08, 'native model units', 'Transmission probability parameter. Maps to SBML symbol `beta`.'), 'exposed_progression_rate': ('sigma', 0.142857, 'native model units', 'Exposed-to-infectious progression parameter. Maps to SBML symbol `sigma`.'), 'daily_contact_rate': ('c', 14.781, 'native model units', 'Daily contact-rate parameter. Maps to SBML symbol `c`.'), 'quarantine_probability': ('q', 1.8887e-07, 'native model units', 'Quarantine probability parameter. Maps to SBML symbol `q`.'), 'hospitalization_rate': ('delta_I', 0.13266, 'native model units', 'Infected-to-hospitalised transition parameter. Maps to SBML symbol `delta_I`.')}
...
Tang2020EstimationOfTransmissionRiskOfCoviBiomd0000000971Model = CuratedEpidemiologySBMLModel
